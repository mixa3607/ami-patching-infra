...
// Brief      : This implementation is to perform restore 
 ...
 * Configurations. It will send RPC request to perform Restore Configurations 
 * Once it is initiated, BMC gets rebooted. So UI is ended with message.
 */
function doRestoreDefault()
{
	if(confirm(eLang.getString("common", "STR_RSTR_CFG_CNFRM"))) {
...
/*
 * It will close the confirmation dialog which is used for Restore Configuration.
 */
