	...
	try
	{
		tblJSON =
		{
			cols:[
				...
				{text:eLang.getString('common',"STR_CHANNEL_NO"), fieldName:'channel_no', fieldType:2, w:'10%', textAlign:'center'},
				{text:eLang.getString('common',"STR_DEST_SELECT"), fieldName:'dest_select', fieldType:2, w:'10%', textAlign:'center'}
			]};
